...
const RelatedProduct = () => {
    const products = [
        { id: 1, title: 'Product 1', description: 'This is a short description of Product 1', price: 30000, image: 'https://i.postimg.cc/bYLdy6GT/i-Phone-15-Plus-2-1-6945.jpg' },
        { id: 2, title: 'Product 2', description: 'This is a short description of Product 2', price: 25000, image: 'https://i.postimg.cc/bYLdy6GT/i-Phone-15-Plus-2-1-6945.jpg' },
        { id: 3, title: 'Product 3', description: 'This is a short description of Product 3', price: 4000, image: 'https://i.postimg.cc/bYLdy6GT/i-Phone-15-Plus-2-1-6945.jpg' },
        ...
        >
          <Link to={`/products/${product.id}`}>
            <div className="relative">
              ...
              />
              <div className="absolute top-2 right-2 transition-transform duration-300 ease-in-out group-hover:scale-105 gradient-bg p-2 rounded-full shadow-md">
            ...
            <p className="text-sm text-[#AFB1B4] group-hover:text-white">{product.description}</p>
            <div className="mt-4 flex justify-between items-center">
              <p className="font-semibold text-white">${product.price.toFixed(2)}</p>
              <button className="px-4 py-2 gradient-bg text-white text-sm font-semibold rounded-full shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2">
                Compare
              </button>
            </div>
          </Link>
