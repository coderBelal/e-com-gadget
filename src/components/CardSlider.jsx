  ...
  return (
    <div className="py-4 mx-auto    max-w-7xl">
      <div className="relative mb-4  ">
        ...
        <h2 className="text-3xl   gradient-text uppercase   font-bold text-center">Ready for Order</h2>
        <button
          onClick={scrollRight}
      ...
      >
        {products.map((product) => (
          <div
            key={product.id}
            className="min-w-[calc(100%/2)] group  md:min-w-[calc(100%/4)] lg:min-w-[calc(100%/6)] flex-shrink-0 rounded-lg p-4 shadow-lg   hover:shadow-2xl"
          >
       ...
       <div className="absolute top-2 right-2    gradient-bg  p-2 rounded-full shadow-md">
            ...
            <h2 className="mt-4 text-lg font-bold   gradient-text">{product.title}</h2>
