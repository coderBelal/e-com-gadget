...
const FeaturedCategories = () => {
  return (
    <div className="py-10 px-4   max-w-7xl mx-auto">
      <h2 className="text-2xl font-bold bg-gradient-to-r from-purple-500 via-pink-500 to-purple-600 bg-clip-text text-transparent text-center mb-4">FEATURED CATEGORIES</h2>
      ...
      <div className="grid grid-cols-4 sm:grid-cols-4 lg:grid-cols-7 gap-4">
        {categories.map((category, index) => (
          ...
          >
            {category.icon}
            <p className="mt-2 text-center text-sm font-medium      bg-gradient-to-r from-purple-500 via-pink-500 to-purple-600 bg-clip-text text-transparent">
              {category.name}
            </p>
          </div>
        ))}
